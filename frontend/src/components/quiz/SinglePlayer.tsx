            ...
            <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                    <Button
                        ...
                        variant="ghost"
                        onClick={() =>
                            setRegion(cycleValue(regions, region, "prev"))
                        }
                        className="bg-muted"
                    >
                    ...
                    <Button
                        ...
                        variant="ghost"
                        onClick={() =>
                            setRegion(cycleValue(regions, region, "next"))
                        }
                        className="bg-muted"
                    >
            ...
            <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                    <Button
                        ...
                        onClick={() =>
                            setDifficulty(
                                cycleValue(difficulties, difficulty, "prev")
                            )
                        }
                        className="bg-muted"
                    >
                    ...
                    <Button
                        ...
                        onClick={() =>
                            setDifficulty(
                                cycleValue(difficulties, difficulty, "next")
                            )
                        }
                        className="bg-muted"
                    >
