        ...
        <div className="grid grid-cols-1 gap-6 mb-6 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 max-w-2xl mx-auto">
            {[
              {
                icon: MapPin,
                value: analysis.region === "" ? "All Region" : analysis.region,
                label: "Region",
              },
              {
                icon: Calendar,
              ...
              { icon: Zap, value: analysis.quizType, label: "Quiz Type" },
            ].map((item, idx) => (
              <ShadcnTooltip key={idx}>
                <TooltipTrigger asChild>
                  ...
                  >
                    <item.icon size={16} style={{ color: "var(--yellow)" }} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 lg:gap-6 h-[calc(100vh-200px)]">
          ...
          >
            ...
            <CardContent className="space-y-4">
              ...
              <Progress value={analysis.accuracy} className="h-3 bg-white/20" />
          ...
          >
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center gap-2">
                <Timer size={20} style={{ color: "var(--yellow)" }} />
                Time Analysis
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-4 text-center">
                ...
                <div>
                  <div
                    ...
                    style={{ color: "var(--success)" }}
                  >
                    {analysis.averageTimePerQuestion / 1000}s
                  </div>
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <div className="rounded px-2 py-1 bg-foreground/10">
                          <p className="text-xs truncate">Your answer was {q.selectedAnswer}</p>
                        </div>
                      </div>
                    </div>
                  ))}
