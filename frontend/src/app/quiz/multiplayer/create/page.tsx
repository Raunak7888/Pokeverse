    ...
    try {
      ...
      if (axios.isAxiosError(error)) {
        if (error.code === "ERR_NETWORK") {
          ...
          customToast.error("An unexpected error occurred while creating the room.");
        }
      } else {
        ...
        >
          ...
          >
            ...
            <div className="text-center min-w-[100px]">
              ...
              <p className="text-xs  text-foreground/50 mt-1">rounds</p>
            </div>
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Button
                size="icon"
        ...
        >
          ...
          >
            ...
            <div className="text-center min-w-[100px]">
              ...
              <p className="text-xs text-foreground/50 mt-1">players</p>
            </div>
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Button
                size="icon"
